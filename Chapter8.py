# -*- coding: utf-8 -*-
"""
Created on Fri Dec 02 19:35:30 2016
...
#plotting users by keeping Django as y and Avengers as x
...
print 'Euclidean distance between Jill and Toby rating is', sqrt(pow(8.5-7,2)+pow(9-6.5,2))

#Euclidean distance between Robert and Max rating

sqrt(pow(8-7,2)+pow(7-7,2))

print 'Euclidean distance between Robert and Max rating is', sqrt(pow(8-7,2)+pow(7-7,2))
...
print 'Similarity Score based on Euclidean distance between Jill and Toby', 1/(1 + sqrt(pow(8.5-7,2)+pow(9-6.5,2)) )
...
print 'Similarity Score based on Euclidean distance between Robert and Max is', 1/(1 + sqrt(pow(8-7,2)+pow(7-7,2)) )
...
print 'Distance-based similarity score for Sam and Toby is', sim_distance(movie_user_preferences,'Sam','Toby')
...
print 'The Pearson correlation between Sam and William is', pearsonr(df.Sam,df.William)
...
print 'The Pearson correlation between Sam and Julia is', pearsonr(df.Sam,df.Julia)
...
print 'Pearson correlation between Sam and Julia is', sim_pearson(movie_user_preferences,'Sam','Julia')
...
print top_matches(movie_user_preferences,'Toby', n = 3, similarity = sim_distance)
...
print get_recommendations(movie_user_preferences,'Toby')
get_recommendations(movie_user_preferences,'Toby',
